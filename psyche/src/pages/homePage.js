    ...
    <div className="home-container">
      ...
      <div className="home-content">
        <div className="home-words">
          <h2 className="h2Psyche">What is Psyche?</h2>
          <p>
            ...
            *Psyche*, to study this potential partial core of a
            planetesimal. The Psyche satellite will reach the asteroid
            by August 2029, revealing more about its composition and appearance.
          </p>
          <p>
