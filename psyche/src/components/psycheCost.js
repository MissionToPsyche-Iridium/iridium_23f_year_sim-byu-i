        ...
        <div class="box">
            ...
            <Accordion>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        Without getting political it is well agreed that the US Nation Debt is very large. As of writing this we are looking at roughly $36 trillion <a class="sup" href={`${process.env.PUBLIC_URL}/Sources`}target="_blank"><sup>t_3</sup></a>. So how many times could we pay off this debt if we somehow sold the Psyche asteroid? 277,778 times. Well that number is a more comprehensible, but still to big for me. Lets go bigger!
                    </AccordionDetails>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        This is going to be a very rough estimate, but lets go for it. According to an article written back in 2022 <a class="sup" href={`${process.env.PUBLIC_URL}/Sources`}target="_blank"><sup>t_4</sup></a> one acre of land in America is on average $12,000. With there being about 2.26 billion acres <a class="sup" href={`${process.env.PUBLIC_URL}/Sources`}target="_blank"><sup>t_5</sup></a> making up America; we would be able to buy the entirety of America, according to these numbers, 368,732 times. Yes that is more times than we would be able to pay off the national debt. I didn't expect it either. Lets go bigger.
                    </AccordionDetails>
